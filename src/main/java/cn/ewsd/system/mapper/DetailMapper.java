...
import cn.ewsd.system.model.Detail;
...
public interface DetailMapper extends CommonMapper<Detail> {
...
//    int queryTotal();
    ...
    List<Detail> getPageSet(@Param("filterSort") String filterSort);

    Detail getDetailByPidAndStepno(String pid, String stepNumber);
