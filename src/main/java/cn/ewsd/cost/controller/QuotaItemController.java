 ...
 */
@Controller
@RequestMapping("/cost/quotaItem")
public class QuotaItemController extends CostBaseController {
    ...
    public String index(@RequestParam Map<String, Object> params) {
        return "cost/quotaItem/index";
    }

    @ResponseBody
    @RequestMapping(value = "/getPageSet", method = RequestMethod.POST)
    public Object getPageSet(PageParam pageParam) {
        String itemType = "m.itemType.31";
...
//
//                String textName = "出账单位,物料分类,物料编码,物料描述,价格,数量,金额,关联费用,工程项目,领料仓库,发生日期,考核日期,出账编号,拆分号,计划预留,出账来源";
//                String fieldName = "teamName,erpType,typeName,matCode,matName,matPrice,matAmount,matBala,itemName,prjName,storeName,occDate,assDate,drawNo,splitNo,reserveNo,drawSrcName";
