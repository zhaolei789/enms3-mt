...
public class tokenUserDataCorpUserCorp {
    private String id;
    private String name;
    ...
    private int status;
    private List<tokenUserDataCorpUserCorpDept> depts;
    ...
    public List<tokenUserDataCorpUserCorpDept> getDepts() {
        return depts;
    }

    public void setDepts(List<tokenUserDataCorpUserCorpDept> depts) {
        this.depts = depts;
    }
