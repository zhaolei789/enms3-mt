...
<table class="editTable">
	...
	<tr>
		...
		<td colspan="3"><input type="text" data-toggle="topjui-textbox" name="text" data-options="required:true,width:700" ></td>
	</tr>
	<tr>
		<td class="label">封面缩略图</td>
		<td colspan="3"><input type="text" data-toggle="topjui-uploadbox" name="thumbnail" data-options="width:700" ></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="3"><input type="text" data-toggle="topjui-textbox" name="description" data-options="width:700" ></td>
	</tr>
	<tr>
		<td class="label">内容</td>
		<td colspan="3">
			<textarea name="content" style="height:300px;"
					  data-toggle="topjui-ueditor" data-options="id:'addContainer'"></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="4">
