...
<table class="editTable">
    ...
    <tr>
        ...
        <td width="278">
            <input name="status" data-toggle="topjui-switchbutton" data-options="onText:'已发布',offText:'未发布'">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            <input type="text" name="thumbnail" data-toggle="topjui-uploadbox" data-options="editable:false,
               buttonText:'上传图片',
               accept:'images',
    ...
    <tr>
        ...
        <td colspan="3">
            <textarea name="content" data-toggle="topjui-ueditor" data-options="id:'contentEditEditor'"></textarea>
        </td>
    </tr>
</table>