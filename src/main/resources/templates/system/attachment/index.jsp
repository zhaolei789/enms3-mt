...
<!-- 附件 表格工具栏 -->
<div id="attachmentDatagrid-toolbar" class="topjui-toolbar">
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="method:'openDialog',
       parentGrid:{
       ...
       dialog:{
           id:'attachmentAddDialog',
           href:'${ctx}/system/attachment/add?dir=file&module=archive&category=default&puuid={parent.uuid}&gridType=datagrid&gridId=attachmentDatagrid',
           height:200
       }">新增</a>
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
