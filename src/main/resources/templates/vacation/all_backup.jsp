...
<rapid:override name="title">所有流程</rapid:override>
            ...
            <c:forEach items="${processDefinitions}" var="processDefinition">
                <tr>
                    ...
                    <td>
                        ...
                        <a id="startProcess" class="layui-btn layui-btn-sm" href="javascript:void(0)" data-proc-def-id="${processDefinition.id}"
                           data-process-name="${processDefinition.name}">启动流程</a>
                        <a class="layui-btn layui-btn-sm layui-btn-danger" href="javascript:window.parent.addParentTab({href:'/workflow/workflow/graphics?definitionId=${processDefinition.id}',title:'流程图 - ${processDefinition.name}'})">流程图</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
