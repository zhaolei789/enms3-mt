$(function () {
    // 等待页面加载完成，链接websocket
        ...
        stompClient.connect({}, function (frame) {
            stompClient.subscribe('/message/webNotice/'+userNameId, function (result) {
        ...
        // 获取未读消息的数量
        setTimeout(function () {
            $.post("/message/msgWebNoticeRelation/getNoReadAmount",{},function (res) {
                var num = res ;
                if(parseInt(num) == 0){
                    return;
                }
...
function addNewMessageTab() {
    var url = '/message/msgWebNotice/myIndex', title ='我的消息', iconCls='fa fa-commenting';
