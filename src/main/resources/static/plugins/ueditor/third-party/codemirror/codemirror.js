...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        function moveV(dir, unit) {
            ...
            else if (unit == "static.json.echarts.line") dist = textHeight();
    ...
    var commands = CodeMirror.commands = {
        ...
        goLineUp: function(cm) {cm.moveV(-1, "static.json.echarts.line");},
        goLineDown: function(cm) {cm.moveV(1, "static.json.echarts.line");},
